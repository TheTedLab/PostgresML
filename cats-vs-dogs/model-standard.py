...
model.save('models/cats_and_dogs_big_standard.h5')
...
plt.savefig('resources/standard-model/big-train-and-val-acc.png', bbox_inches='tight')
plt.figure()
...
plt.savefig('resources/standard-model/big-train-and-val-loss.png', bbox_inches='tight')
plt.show()
