...
test_loss, test_acc = model_standard.evaluate_generator(test_generator, steps=50)
...
test_loss, test_acc = model_data_aug.evaluate_generator(test_generator, steps=50)
