...
if choose == 'models':
    ...
    model_standard = models.load_model('models/cats_and_dogs_big_standard.h5')
    ...
    model_data_aug = models.load_model('models/cats_and_dogs_big_data_aug.h5')
    ...
    model_pretrained = models.load_model('models/cats_and_dogs_big_pretrained.h5')
